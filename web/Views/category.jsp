...
<html lang="en">
    ...
    <body>
        <c:set var="id" value="${requestScope.cateId}"/>
                ...
                <div class="hero-wrap js-fullheight" style="background-image: url(images/bg_1.jpg);" data-stellar-background-ratio="0.5">
                    ...
                    <div class="js-fullheight d-flex justify-content-center align-items-center">
                        <div class="col-md-8 text text-center">
                            <div class="img mb-4" style="background-image: url(images/khai.png);"></div>
                            <div class="desc">
                                <h2 class="subheading">Hello I'm</h2>
                                <h1 class="mb-4">Trinh Dinh Khai</h1>
                                <p class="mb-4">I'm studying at FBT university. This is my project for the class PRJ301 of Mr.KhuongPD. Posts and information on this website may not be true, but I DON'T CARE.</p>
                    ...
                    <div class="container">
                        <div class="row justify-content-center mb-5 pb-2">
                            <div class="col-md-7 heading-section text-center ftco-animate">
                                <h2 class="mb-4">${cMap.get(id).getName()}</h2>
                                <p>A small river named Duden flows by their place and supplies it with the necessary regelialia. It is a paradisematic country.</p>
                            </div>
                        </div>
                        <div class="row">
                            <c:forEach items="${requestScope.DAO.nList}" var="st">
                                <c:if test="${(st.cateId==id) && (st.active==true || sessionScope.UserLogined.getRoleId()==1)}">
                                    <div class="col-md-4">
                                        <div class="blog-entry ftco-animate">
                                            <a href="NewsController?type=1&id=${st.id}" class="img img-2" style="background-image: url(${st.image});" ></a>
                                            <div class="text text-2 pt-2 mt-3">
                                                <span class="category mb-3 d-block"><a href="#">${cMap.get(st.cateId).getName()}</a></span>
