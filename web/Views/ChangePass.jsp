                ...
                <div class="container col-md-8 col-md-offset-3" style="overflow: auto">
                    <div class="card-body p-4 p-lg-5 text-black">
                        <form action="<%=request.getContextPath()%>/ChangePassword" method="post">
                            ...
                            <h5 class="fw-normal mb-3 pb-3" style="letter-spacing: 1px;">Be carefull</h5>
                            <div class="alert alert-success center mb-4" role="alert">
                                <p>${NOTIFICATION}</p>
                            </div>

                            <div class="form-outline mb-4">
                                <input type="password" class="form-control form-control-lg" placeholder="Old password" name="oldPass" required>
                            </div>

                            <div class="form-outline mb-4">
                                <input type="password" class="form-control form-control-lg" placeholder="New password" name="newPass" required>
                            </div>
