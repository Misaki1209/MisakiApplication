                    ...
                    <div class="card-body p-4 p-lg-5 text-black">
                        <form action="<%=request.getContextPath()%>/LoginController" method="post">
                            ...
                            <div class="form-outline mb-4">
                                <input type="text" class="form-control form-control-lg" id="username" placeholder="User Name" name="username" required>
                            </div>
                            ...
                            <a class="small text-muted" href="<%=request.getContextPath()%>/ForgotPass">Forgot password?</a>
                            <p class="mb-5 pb-lg-2" style="color: #393f81;">Don't have an account? <a href="<%=request.getContextPath()%>/RegisterController" 
