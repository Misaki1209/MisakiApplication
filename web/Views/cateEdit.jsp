                ...
                <div class="container col-md-12 col-md-offset-3" style="overflow: auto">
                    <div class="card-body p-4 p-lg-5 text-black">
                        <table class="table">
                            ...
                            <tbody>
                                <c:forEach items="${cMap}" var="cate">
                                    
                                        <tr>
                                            <td>${cate.value.name}</td>
                                            
                                            <td><a href="CateUpdate?CateId=${cate.value.id}&CateType=0" class="btn btn-secondary active" role="button" aria-pressed="true">Rename</a></td>
                                            <td><a href="CateUpdate?CateId=${cate.value.id}&CateType=1" class="btn btn-secondary active" role="button" aria-pressed="true">Delete</a></td>
                                        </tr>
                ...
                <div class="container col-md-8 col-md-offset-3" style="overflow: auto">
                    <div class="card-body p-4 p-lg-5 text-black">
                        <form action='CateUpdate' method='post'>
                            <input type="text" hidden name="CateId" value="${requestScope.Category.getId()}">
                            <div class="form-group row">
                                <label class="col-sm-2 col-form-label">Category: </label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="CateName" value="${requestScope.Category.getName()}">
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="col-sm-10">
                                    <button type="submit" class="btn btn-primary">Update/Insert</button>
                                </div>
                            </div>
                        </form>
                    </div>
