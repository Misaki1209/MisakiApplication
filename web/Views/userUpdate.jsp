                    ...
                    <div class="card-body p-4 p-lg-5 text-black">
                        <form action="<%=request.getContextPath()%>/UserController" method="post">
                            <div class="d-flex align-items-center mb-3 pb-1">
                                <img src="${sessionScope.UserLogined.getAvatar()}" class="rounded-circle"
                                                     height="150" alt="Avatar" loading="lazy" />
                            </div>
                            ...
                            <div class="form-outline mb-4">
                                Full name: <input type="text" class="form-control form-control-lg" name="fullname" value="${sessionScope.UserLogined.getFullname()}" required>
                            </div>

                            <div class="form-outline mb-4">
                                Username: <input type="text" class="form-control form-control-lg" name="username" value="${sessionScope.UserLogined.getUsername()}" required>
                            </div>
                            
                            <div class="form-outline mb-4">
                                Email: <input type="text" class="form-control form-control-lg" name="email" value="${sessionScope.UserLogined.getEmail()}" required>
                            </div>
                            ...
                            <div class="form-outline mb-4">
                                Date of birth: <input type='date' class="form-control form-control-lg" name='dob' value="${sessionScope.UserLogined.getDob()}" required>
                            </div>
                            
                            <div class="form-outline mb-4">
                                Address: <input type="text" class="form-control form-control-lg" name="address" value="${sessionScope.UserLogined.getAddress()}" required>
                            </div>
                            
                            <div class="form-outline mb-4">
                                Avatar: <input type="text" class="form-control form-control-lg" name="avatar" value="${sessionScope.UserLogined.getAvatar()}" required>
                            </div>

                            <div class="form-outline mb-4">
                                Security Question: <select class="form-control form-control-lg"  name="quesId" >
                                    <c:forEach items = "${requestScope.DAO.questHm}" var="i">
                                        <option value="${i.value.id}" ${sessionScope.UserLogined.getQuesId()==i.value.id?"selected":""}>${i.value.question}</option>
                                    </c:forEach>
                                </select>
                            </div>

                            <div class="form-outline mb-4">
                                Answer: <input type="text" class="form-control form-control-lg" name="answer" value="${sessionScope.UserLogined.getAnswer()}" required>
                            </div>
